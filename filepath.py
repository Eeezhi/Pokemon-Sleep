...
img_path = os.path.join(assertsBASE_DIR, "img")
database_path = os.path.join(assertsBASE_DIR, "data")

# POKEMON_SLEEP_IMG = os.path.join(img_path, "pokemon_sleep.png")
# CALCULATOR_IMG = os.path.join(img_path, "calculator.jpeg")
# RECIPE_IMG = os.path.join(img_path, "recipe.png")
# POKEMON_IMG = os.path.join(img_path, "pokemon.png")
#部署在服务器上时避免路径错误
